/*
    This header file is part of ZeroMQ compatibility feature of nanomsg project.
    It is directly copied from ZeroMQ project. Original content of the file
    follows.

    NOTE: The message definition (zmq_msg_t) is slightly modified to work well
          with nanomsg backend.
*/
